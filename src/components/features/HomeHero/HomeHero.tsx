      ...
      <div className="md-container ">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="pt-52 text-white open-sans">
            ...
            <span className="text-4xl font-normal font-thin">
...
const HomeShape = () => {
  return (
    <svg
      ...
      className="absolute bottom-[-140px] w-[600px] left-[-85px]"
    >
      <g
...
const HomeLines = () => {
  return (
    <svg
      ...
      className="w-[75px] absolute bottom-[300px]"
    >
      <rect
        width="95.7397"
        height="37.53"
...
const HomeMe = () => {
  return (
    <div className={`${styles.me} w-[400px] h-[520px] absolute bottom-0`}></div>
  );
};
